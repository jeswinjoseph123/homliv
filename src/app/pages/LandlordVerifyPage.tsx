  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden bg-surface-low">
      ...
      <div className="flex flex-1 overflow-hidden min-h-0">
        ...
        {/* Col 1 — dashboard nav sidebar (w-[210px]) */}
        <LandlordSidebar
          activeTab={'settings' as Tab}
          onNav={() => navigate('/dashboard')}
          isOpen={sidebarOpen}
          onClose={() => setSidebarOpen(false)}
        />

        {/* Col 2 — verification progress sidebar (w-44 = 176px) */}
        <aside
          className="hidden lg:flex flex-col w-44 shrink-0 bg-white h-full"
          style={{ boxShadow: '1px 0 0 rgba(220,193,183,0.2)' }}
        >
          <div className="flex flex-col flex-1 pt-8 pb-6 px-3">
        ...
        <main className="flex-1 overflow-y-auto min-w-0">
          <div className="w-full max-w-lg mx-auto px-5 py-8">
            ...
            <div className="h-1.5 rounded-full bg-ghost/20 mb-6 overflow-hidden">
              <div
            ...
            {/* Form card */}
            <div className="bg-white rounded-2xl p-6 shadow-[0_4px_24px_rgba(23,27,43,0.08),_0_1px_4px_rgba(23,27,43,0.04)]">
              <div className="mb-7">
        ...
        {/* Col 4 — trust panel, always visible */}
